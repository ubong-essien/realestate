                    ...
                    <div class="col-lg-8 col-md-8 single-list-page" style="background-color:#d5d9d9;padding-top:30px;height:100%!important;font-family:arial narrow">
                        ...
                        <a href="<?= base_url('create_docs');?>" class="btn btn-primary" style="width:100px;"><li class="fa fa-plus"></li> Add New</a><br/>
                               <div class="row">
								...
								?>
                                    <tr><td><?= $t ?></td><td><?= $docs['doc_title'];?></td><td><?= $docs['doc_descr'];?></td><td><button class="btn btn-success"><li class="fa fa-file"></li></button></td><td><button class="btn btn-success"><li class="fa fa-edit"></li></button></td><td><button class="btn btn-danger"><li class="fa fa-trash"></li></button></td></tr>
								  <?php
								 
									endforeach; 
									else:
									?>
									<tr><td>No document Available</td></tr>
                                  <?php 
								endif;
								  ?>
								  </table>
